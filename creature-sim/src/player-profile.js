...
export const PROFILE_STORAGE_KEYS = {
  ...
  mobile: ['creature-mobile-focus', 'creature-mobile-battery', 'creature-mobile-haptics', 'creature-last-spawn-type'],
  progress: [
    'achievements',
    'campaign_progress',
  ...
  saves: ['creature-sim-autosave', 'creature-sim-autosave-preview']
};
  ...
  return {
    ...
    preferences: {
      accessibility: {
        ...
        reducedMotion:
          readBoolean(resolvedStorage, 'creature-sim-reduced-motion') ??
