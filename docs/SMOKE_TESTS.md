...
6. **Tap targets**
   ...
   - Automated smoke should report `layoutGuardPassed: true`, no offscreen visible controls, and at least 40px visible touch targets in `output/browser-smoke/runtime-readiness.json`.
